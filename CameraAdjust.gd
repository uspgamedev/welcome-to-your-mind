...
export (int) var left_limit = -100000000
export (float, 5.0) var left_time = 0.5
export (int) var top_limit = -100000000
export (float, 5.0) var top_time = 0.5
export (int) var right_limit = 100000000
export (float, 5.0) var right_time = 0.5
export (int) var bottom_limit = 100000000
export (float, 5.0) var bottom_time = 0.5
export (float, 0.3, 3) var zoom = 1.0
export (float, 5.0) var zoom_time = 0.5
