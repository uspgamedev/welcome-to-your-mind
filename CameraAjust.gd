...
func adjust_camera(Cam):
	...
	$Tween.interpolate_property(Cam, "limit_left", Cam.limit_left, left_limit + p_pos.x, adjust_time, Tween.TRANS_QUAD, Tween.EASE_IN_OUT)
	$Tween.interpolate_property(Cam, "limit_right", Cam.limit_right, right_limit + p_pos.x, adjust_time, Tween.TRANS_QUAD, Tween.EASE_IN_OUT)
	$Tween.interpolate_property(Cam, "limit_top", Cam.limit_top, top_limit + p_pos.y, adjust_time, Tween.TRANS_QUAD, Tween.EASE_IN_OUT)
	$Tween.interpolate_property(Cam, "limit_bottom", Cam.limit_bottom, bottom_limit + p_pos.y, adjust_time, Tween.TRANS_QUAD, Tween.EASE_IN_OUT)
